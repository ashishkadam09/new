<?php
    ...
    // Instantiation and passing [ICODE]true[/ICODE] enables exceptions
        ...
        //Recipients
        $mail->setFrom('mail@saraswebtech.in', 'yn container Contact Form');
        $mail->addAddress('saraswebtech@gmail.com', 'yn container'); // Add a recipient
    	...
    	if(!$mail->send()) {
    	    ...
    	    echo 'Mailer Error: ' . $mail->ErrorInfo;
                ...
                echo "setTimeout(function(){ window.location.href = 'contact-yncontainer-services.html'; }, 3000);";  // Redirect after 3 seconds
                echo "</script>";
    	}
    ?>